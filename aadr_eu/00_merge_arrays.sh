...
#
# Usage:
#   ./aadr_eu/00_merge_arrays.sh <plink_prefix_A> <plink_prefix_B> <outdir>
#
# Example:
#   ./aadr_eu/00_merge_arrays.sh MH_PW/pw_plink FF_PW/pw_plink PW_MH_FF
#
...
echo "  Next: Rscript aadr_eu/02_build_aadr_subset.R <aadr_prefix> ./$OUTDIR"
echo "================================================================================"
